...
class MosesAIClient {
  constructor() {
    this.baseURL =
      'https://caaz2t8bwh.execute-api.us-east-1.amazonaws.com/prod';
    ...
    try {
      ...
      return {
        ...
        data: {
          ...
          version: '1.0.0',
          description:
            "Professional AI assistant backed by Moses Omondi's expertise in DevSecOps, Software Engineering, and AI",
          status: 'offline',
        },
      };
    }
    ...
    try {
      ...
      return {
        ...
        data: {
          ...
          experience:
            'Professional expertise in building secure, scalable systems',
        },
      };
    }
  }
  ...
  async query(question, context = {}) {
    ...
    try {
      ...
      return {
        error: true,
        message:
          "I'm currently offline, but I'd be happy to help when the connection is restored.",
  ...
  generateFallbackResponse(question) {
    ...
    if (
      lowerQuestion.includes('devsecops') ||
    ...
    if (
      lowerQuestion.includes('docker') ||
      lowerQuestion.includes('kubernetes')
    ) {
